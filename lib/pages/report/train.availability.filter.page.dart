          ...
          child: new ListView(
            ...
            children: [
              ...
              new InputDecorator(
                decoration: const InputDecoration(
                  labelText: 'Group By',
                  hintText: 'Choose Group By',
                ),
                isEmpty: _groupBy == null,
                child: new DropdownButton<String>(
                  value: _groupBy,
                  isDense: true,
                  onChanged: (String newValue) {
                  ...
                  items: <String>['trainCar', 'trainSet'].map((String value) {
                    return new DropdownMenuItem<String>(
                      value: value,
                      child: new Text(value.toString() == 'trainCar' ? 'Train Car' : 'Train Set'),
                    );
                   }).toList(),
                ),
              ),
